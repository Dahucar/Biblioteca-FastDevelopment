 ...
 */
public class ControladorAsociarTelefonoCliente implements ActionListener{
    ...
    public ControladorAsociarTelefonoCliente(Cliente modeloCli, Telefono modelTel, AsociarNumero vista, AsociarNumeroSql sql) {
    ...
    public void muestrate() {
        ...
        this.vista.setTitle("Biblioteca Fastdevelopment | Gestión asociar telefono cliente");
        this.vista.txt_tituloTabla.setText("Telefonos asociados con Trabajador: " + this.modeloCli.getNombre());
    ...
    private boolean llenar(JTable tabla, boolean igualdad) {
        ...
        int listadoid[] = sql.idTelefonoSinAñadirCliente(id, sql.getCantidadCliente(id));
        ...
        ArrayList<Telefono> listado = sql.listadoTelefonoAñadirCliente(listadoid, igualdad, id);
    ...
    private void asociar() {
        try {
            if (!telTemp.equals(null)) {
                if (sql.insertCliente(modeloCli.getId(), telTemp.getId())) {
    ...
    private void quitar() {
        try {
            if (!telTemp.equals(null)) {
                if (sql.deleteCliente(modeloCli.getId(), telTemp.getId())) {
